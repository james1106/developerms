...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>优云运维应用软件市场-应用者认证111</title>
	...
	<script src="./- 微擎云服务平台qy_files/pace.min.js"></script>
	<script src="./- 微擎云服务平台qy_files/require.js"></script>
	<script src="./- 微擎云服务平台qy_files/config.js"></script>
	<script src="./- 微擎云服务平台qy_files/jquery-1.11.1.min.js"></script>
	<script src="./- 微擎云服务平台qy_files/bootstrap.min.js"></script>
	<script src="./- 微擎云服务平台qy_files/util.js"></script>
	<script>window.sys={debug:false}</script>
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="district" src="./- 微擎云服务平台qy_files/district.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="css" src="./- 微擎云服务平台qy_files/css.min.js"></script><link type="text/css" rel="stylesheet" href="./- 微擎云服务平台qy_files/layer.css"><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="layer" src="./- 微擎云服务平台qy_files/layer.js"></script></head>
...
<div class="header">
	<div class="wrapper clearfix">
		<ul class="nav pull-left" role="tablist">
			...
			<li role="presentation">
				<a href="https://s.we7.cc/index.php?c=wiki&do=view&id=1" target="_blank" class="link">开发文档</a>
			</li>
			<li role="presentation">
...
<div class="aside">
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=order&" class="menu-new">我的订单</a>
		</div>
		<div class="list-group-item ">
	...
	<div class="list-group">
		...
		<div class="list-group-item  active ">
			<a href="./- 微擎云服务平台qy_files/- 微擎云服务平台qy.htm" class="menu-new">企业认证</a>
		</div>
		<div class="list-group-item">
	...
	<div class="text-center">
		<img src="./- 微擎云服务平台qy_files/wx.png" width="100" title="扫二维码">
...
<!--end aside-->
		...
		<ul class="alert alert-warning">
			<li><h3>微擎团队强烈建议企业资质认证开发者</h3></li>
			<li><i class="fa fa-info-circle"></i> 开发者企业认证需完善各项认证信息，缺一不可。</li>
			<li><i class="fa fa-info-circle"></i> 开发者企业认证可自行为用户提供发票，而不必向微擎缴纳发票代开税。</li>
		</ul>
...
<script type="text/javascript">
	...
	<div class="input-group" style="margin-top:.5em;">
		<img src="./- 微擎云服务平台qy_files/nopic.jpg" class="img-responsive img-thumbnail" width="150">
	</div>						</div>
					</div>
					<div class="form-group">
