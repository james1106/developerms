...
<div class="wrapper js-body clearfix" style="min-height: 1064px;">
			...
			<li><i class="fa fa-info-circle"></i> 请填写应用者认证资料信息，提交后将由管理员审核。</li>
			<li><i class="fa fa-info-circle"></i> 审核通过后您的应用者身份等级、论坛用户组将会发生变化。</li>
		</ul>
					<!-- 初中高级开发者验证 -->
<div class="panel panel-default">
	<div class="panel-heading">应用者认证</div>
	<div class="panel-body">
		<div class="form-group">
			<form method="post" action="${ctx}/apper/doEnterpriseCertification" class="form-horizontal">
				<div class="form-group">
