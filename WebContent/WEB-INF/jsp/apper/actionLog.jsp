...
<div class="container">
	...
	<div class="we7-page-title">查看日志记录</div>
<ul class="we7-page-tab">
	
	<li class="active"><a href="">软件操作日志记录</a></li>
	<li><a href="">数据库日志</a></li>
	<li><a href="">系统日志</a></li>
</ul>
<div class="clearfix">
	<!--<h5 class="page-header">日志信息</h5>-->
	<!-- 筛选功能 -->
			<form action="" method="get" class="we7-form form-inline" role="form">
...
<script type="text/javascript">
	...
	<input name="time[start]" type="hidden" value="2017-10-31">
	<input name="time[end]" type="hidden" value="2017-10-31">
	<button class="btn btn-default daterange daterange-date" type="button"><span class="date-title">2017-10-31 至 2017-10-31</span> <i class="fa fa-calendar"></i></button>
						</div>
	...
	<!-- 系统日志 -->
        ...
        <tr>
            ...
            <td style="width:150px;">2017-10-31 10:04:21</td>
			<td style="width:120px;">0.001s</td>
			<td style="width:150px;">2017-10-31 10:04:22</td>
        ...
        <tr>
            <td style="width:100px;">zhangwan</td>
            <td style="width:120px;">人事管理</td>
            <td style="width:150px;">http://demo.youyun.com:8080/YouYunPlatform/hr_bbb/getdepts</td>
			<td style="width:150px;">action:getDepts  </td>
            <td style="width:150px;">2017-10-31 10:01:11</td>
			<td style="width:120px;">0.002s</td>
			<td style="width:150px;">2017-10-31 10:01:22</td>
            <td style="width:150px;">查询</td>
            <td ><a href="${ctx}/apper/actionLogDetails">详情</a></td>
		</tr>
         <tr>
            <td style="width:100px;">zhangwan</td>
            <td style="width:120px;">人事管理</td>
            <td style="width:150px;">http://demo.youyun.com:8080/YouYunPlatform/hr_bbb/updatedepts</td>
			<td style="width:150px;">action:updateDepts  </td>
            <td style="width:150px;">2017-10-31 09:55:10</td>
			<td style="width:120px;">0.002s</td>
			<td style="width:150px;">2017-10-31 09:55:22</td>
            <td style="width:150px;">更新</td>
            <td ><a href="${ctx}/apper/actionLogDetails">详情</a></td>
		</tr>
         <tr>
            <td style="width:100px;">liming</td>
            <td style="width:120px;">汽车管理系统</td>
            <td style="width:150px;">http://demo.youyun.com:8080/YouYunPlatform/cha_v1/getCars</td>
			<td style="width:150px;">action:getCars  </td>
            <td style="width:150px;">2017-10-31 09:33:12</td>
			<td style="width:120px;">0.002s</td>
			<td style="width:150px;">2017-10-31 09:33:22</td>
            <td style="width:150px;">查询</td>
            <td ><a href="${ctx}/apper/actionLogDetails">详情</a></td>
		</tr>
        <tr>
            <td style="width:100px;">liming</td>
            <td style="width:120px;">汽车管理系统</td>
            <td style="width:150px;">http://demo.youyun.com:8080/YouYunPlatform/cha_v1/updateCars</td>
			<td style="width:150px;">action:updateCars  </td>
            <td style="width:150px;">2017-10-31 09:30:12</td>
			<td style="width:120px;">0.002s</td>
			<td style="width:150px;">2017-10-31 09:31:17</td>
            <td style="width:150px;">更新</td>
            <td ><a href="${ctx}/apper/actionLogDetails">详情</a></td>
		</tr>
        <tr>
