...
<div class="header">
	<div class="wrapper clearfix">
		<ul class="nav pull-left" role="tablist">
			...
			<li role="presentation">
				<a href="${ctx}/index" target="_blank" class="link">商城首页</a>
			</li>
			<li role="presentation">
		...
		<div class="pull-right login-info">
			<a href="http://s.we7.cc/index.php?c=develop&a=message&" style="margin-right: 1em; text-align: center; display: inline-block; line-height: 2em;">
				<i class="fa fa-envelope"></i>
				<span class="badge" id="developer-message-count">1</span>
			</a>
			<span style="margin-right: 1em;">
				<i class="fa fa-user"></i> erabits			</span>
			<a href="http://s.we7.cc/index.php?c=develop&a=logout&">退出</a>
		</div>
	</div>
</div>
...
<div class="aside">
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=pay-password&">支付密码</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=auth&">数字证书</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=message&" class="menu-new">站内消息</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=wiki&do=list&" class="menu-new">文档</a>
		</div>
	</div>
	...
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=api&do=mine&">我的API</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=api&do=trade&">已购API</a>
		</div>
		<div class="list-group-item  active ">
			<a href="http://s.we7.cc/index.php?c=develop&a=api&do=mall&">API广场</a>
		</div>
	</div>
	...
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=sms&do=account&" class="menu-new">
				账户余额
			</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=sms&do=sms_content&op=display&" class="menu-new">
				群发内容
			</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=sms&do=site&op=display&" class="menu-new">
				群发短信
			</a>
		</div>
		<div class="list-group-item ">
			<a href="http://s.we7.cc/index.php?c=develop&a=sms&do=template&op=display&">短信模板</a>
		</div>
	</div>

	<div class="text-center">
		<img src="./API详情 - 微擎云服务平台_files/wx.png" width="100" title="扫二维码">
...
<!--end aside-->
	...
	<ul class="category-nav clearfix">
		<li class="active"><a href="http://s.we7.cc/index.php?c=develop&a=api&do=mall&">API开发接口</a></li>
	</ul>
</div>
	<style>
...
<div class="panel panel-default">
	...
	<div class="panel-body form-horizontal">
		<form action="http://s.we7.cc/index.php?c=develop&a=api&do=debug&id=5" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<div class="footer">
	<div class="wrapper clearfix">
		<ul>
			...
			<a href="http://www.we7.cc/manual/" target="_blank">微擎技术文库</a>
		</ul>
...
<script type="text/javascript" src="./API详情 - 微擎云服务平台_files/s.php" charset="UTF-8"></script><script type="text/javascript" src="./API详情 - 微擎云服务平台_files/stats" charset="UTF-8"></script>
