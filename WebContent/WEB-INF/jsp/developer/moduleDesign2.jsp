...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>设计模块 - 微擎云服务平台</title>
	<meta name="keywords" content="微擎应用商城">
	<meta name="description" content="微擎应用商城">
	<link rel="shortcut icon" href="${ctx}/images/we/14599282165704bc988a2db_IlrylC66kFce.jpg">
...
<script src="${ctx}/js/we/codemirror.js" type="text/javascript" defer="defer">
</script><link rel="stylesheet" type="text/css" href="${ctx}/css/we/codemirror.css">
	...
	<div class="wrapper clearfix">
		<ul class="nav pull-left" role="tablist">
			<li role="presentation" class="active">
				<a href="https://s.we7.cc/index.php?c=develop&a=home&">个人中心</a>
			</li>
			<li role="presentation">
				<a href="https://s.we7.cc/index.php?c=develop&a=auth&" class="link">开发者工具</a>
			</li>
			<li role="presentation">
				<a href="https://s.we7.cc/index.php?c=develop&a=role&" class="link">开发者等级</a>
			</li>
			<li role="presentation">
				<a href="https://s.we7.cc/" target="_blank" class="link">商城首页</a>
			</li>
			<li role="presentation">
				<a href="https://www.we7.cc/manual/" target="_blank" class="link">开发文档</a>
			</li>
			<li role="presentation">
				<a href="http://bbs.we7.cc/forum-66-1.html" target="_blank" class="link">需求市场</a>
			</li>
		</ul>
		<div class="pull-right login-info">
			<a href="https://s.we7.cc/index.php?c=develop&a=message&" style="margin-right: 1em; text-align: center; display: inline-block; line-height: 2em;">
				<i class="fa fa-envelope"></i>
				<span class="badge" id="developer-message-count">1</span>
			</a>
			<span style="margin-right: 1em;">
				<i class="fa fa-user"></i> erabits			</span>
			<a href="https://s.we7.cc/index.php?c=develop&a=logout&">退出</a>
		</div>
	</div>
</div>
<div class="wrapper clearfix">
...
<div class="aside">
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=home&">我的发布</a>
		</div>
		<div class="list-group-item  hidden">
			<a href="https://s.we7.cc/index.php?c=develop&a=service&">我的服务</a>
		</div>
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=record&">交易记录</a>
		</div>
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=report&">举报盗版</a>
		</div>
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=pirate&">盗版查看</a>
		</div>
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=scheme-applyer&">
				悬赏文案
			</a>
		</div>
	</div>
	<div class="list-group">
		...
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=company_verify&" class="menu-new">企业认证</a>
		</div>
		<div class="list-group-item">
			<a href="https://s.we7.cc/index.php?c=develop&a=role&do=reg&op=regular&" class="menu-new">开发者认证</a>
		</div>
	</div>
	<div class="list-group">
		<div class="list-group-item title">
		...
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=site&">测试站点</a>
		</div>
		<div class="list-group-item ">
			<a href="https://s.we7.cc/index.php?c=develop&a=demo&">演示站点</a>
		</div>
	</div>

	<div class="text-center">
		<img src="${ctx}/js/we/wx.png" width="100" title="扫二维码">
		<p>用微信扫描二维码<br>随时掌握应用动态</p>
	</div>
</div>
<!--end aside-->
				<ul class="alert alert-warning">
			<li><i class="fa fa-info-circle"></i> &nbsp;&nbsp;推荐使用 <a href="https://www.we7.cc/manual/" target="_blank">微擎模块开发助手</a> 设计模块框架</li>
	...
	<div class="panel-body">
		<form action="./设计模块 - 微擎云服务平台_files/设计模块 - 微擎云服务平台.htm" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<img src="${ctx}/images/we/nopic.jpg" class="img-responsive img-thumbnail" width="150">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<span class="help-block">
						<strong class="red">必填 </strong> ,模块功能描述, 模块安装后在微擎中显示, 使用简单的语言描述模块的作用, 来吸引用户 
					</span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<span class="help-block">
						<strong class="red">必填 </strong> ,模块详细描述, 模块安装后在微擎中显示, 简要介绍模块的功能和使用方法
					</span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="http://bbs.we7.cc/" name="url" value="">
					<span class="help-block">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">适用公众号类型</label>
				<div class="col-sm-10">
										<label class="checkbox-inline">
						<input type="checkbox" name="account_type[]" checked="checked" value="0">全部类型					</label>
										<label class="checkbox-inline">
						<input type="checkbox" name="account_type[]" value="1">个人订阅号					</label>
										<label class="checkbox-inline">
						<input type="checkbox" name="account_type[]" value="2">认证订阅号					</label>
										<label class="checkbox-inline">
						<input type="checkbox" name="account_type[]" value="3">服务号					</label>
										<label class="checkbox-inline">
						<input type="checkbox" name="account_type[]" value="4">认证服务号					</label>
										<span class="help-block">
						<strong class="red">必填 </strong> ,设置应用适用的公众号类型
					</span>
				</div>
			</div>
			<div class="form-group">
...
<div class="footer">
	<div class="wrapper clearfix">
		<ul>
			<a href="http://t.qq.com/we7team" target="_blank">官方微博</a><span class="pipe">|</span>
			<a href="http://bbs.we7.cc/" target="_blank">意见及建议反馈</a><span class="pipe">|</span>
			<a href="http://bbs.we7.cc/" target="_blank">服务协议</a><span class="pipe">|</span>
			<a href="https://www.we7.cc/manual/" target="_blank">微擎技术文库</a>
		</ul>
		<div>Copyright © 2013-2015 
			<a href="https://www.we7.cc/" target="_blank">微擎.</a>
		</div>
	</div>
</div>
