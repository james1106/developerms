...
<!--end step-->				<ul class="alert alert-warning">
	...
	<div class="panel-heading">
		参数设置 <span class="pull-right">【${module.title}】 - 【1.0】</span>
	</div>
	<div class="panel-body">
		<form action="${ctx}/developer/module/nextStep2" id="form1" method="post" class="form-horizontal" enctype="multipart/form-data">
