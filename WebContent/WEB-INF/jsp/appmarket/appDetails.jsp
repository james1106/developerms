...
<div id="buy_info" class="details-message"><div class="panel panel-details-message"><div class="panel-body"><div class="media"><div class="media-left media-top message-icon"><!----> <img src="${app.logo}" alt="应用icon"> <a href="javascript:;" class="hidden"><p><i class="wi wi-share"></i>分享</p></a> <a href="javascript:;" class="favorite"><p><i class="fa fa-star-o"></i>
	...
	适用：
						<span>全部类型</span></div> <div class="details-message-site "><span class="control-label pull-left">站点：</span> <div class="col-xs-10"><div id="dropdown1" class="dropdown"><a id="buy-site" data-toggle="dropdown" class="dropdown-toggle"><div class="placeholder"><p class="select-site-name"><span>互正软件运维开发平台</span>
						 (<span>商业版</span>)
	...
	声明：
	<a href="" target="_blank">免责声明</a> <a href="http:/s.we7.cc/index.php?c=wiki&do=view&id=3&list=368%C2%A0" target="_blank">授权协议</a></div></div></div></div> <div class="panel-footer">备注： 本应用必须在互正软件运行环境上使用，点击
